...
list_of_files <- list.files(path="05",pattern = "*.dat",recursive=TRUE) ##Read data from Picarro
L<-length(list_of_files)

setwd(".../VOC Interferences/G2508 borrowed/05")
...
setwd(".../VOC Interferences/NH3 Picarro/05")
...
setwd(".../VOC Interferences/BackPack/05")
